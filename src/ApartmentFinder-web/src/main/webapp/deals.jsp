...
<form action='/ApartmentFinder-web/saveDeals' method='post'>
           ...
           <tr>
             <%
                 ...
                 if(status.equalsIgnoreCase("success")){
                    %>
      <div class="status"> Successfully Added the new Deals</div>
                    <%
                 }else if(status.equalsIgnoreCase("error")){
                    %>
                    <div class="status"> Failed to Add the new Deals</div>
                    <%
                 }else{
                    %>
        ...
        <td colspan="4">
                      ...
                      <html:hidden property="id"/>
                        ...
                        <tr bgcolor="#eeeee">
                          ...
                          <td colspan=2 width="354" height="15"><textarea rows="4" cols="100" name="description">
                              </textarea>
                          </td>
                        </tr>
                        <tr bgcolor="#eeeee">
...
<html:javascript formName="dealsForm" />
